...
public class Util {
    ...
    private static final String USERNAME = "root009";
    private static final String PASSWORD = "Z89115688z!x";
        ...
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/mydbtest?useUnicode=true&useSSL=true&useJDBCCompliantTimezoneShift=true" +
                        "&useLegacyDatetimeCode=false&serverTimezone=UTC");
                settings.put(Environment.USER, "root009");
                settings.put(Environment.PASS, "Z89115688z!x");
